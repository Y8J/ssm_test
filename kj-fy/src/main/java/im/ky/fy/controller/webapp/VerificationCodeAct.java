...
@RequestMapping("vc")
@Controller
public class VerificationCodeAct {
	 ...
	 * @throws IOException
	 */
	@RequestMapping("govc.do")
	public void goVc(HttpServletRequest request, HttpServletResponse response,ModelMap model) throws WriterException, IOException{
		...
		for (int i = 0; i < 4; i++){
			...
			g.drawString(temp, 20 * i + offsetLeft, 22);
		}
	...
	public String gohtmlvc(HttpServletRequest request, HttpServletResponse response,ModelMap model){
